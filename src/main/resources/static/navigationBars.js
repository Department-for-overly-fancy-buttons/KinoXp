...
export function displayNavigationBar(){
    ...
    let homeLinkEl = createHtmlElement({tagName: "a", htmlClass: "navigationLink", htmlAttributes: {id: "logoTitle", href: "http://localhost:8090/", textContent: "KinoXP", title: "Home"}});
    ...
    let theaterLinkEl = createHtmlElement({tagName: "a",htmlClass: "navigationLink", htmlAttributes: {href: "http://localhost:8090/theaters/theaters.html", title: "Theaters", textContent: "Theaters"}});
